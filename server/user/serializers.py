...
class RegistrationSerializer(serializers.ModelSerializer):
    ...
    def save(self):
        ...
        ethereum_wallet_address = self.validated_data["ethereum_wallet_address"]
        if ethereum_wallet_address is None or ethereum_wallet_address == "":
            raise serializers.ValidationError({"ethereum_wallet_address": "wallet address cannot be null or empty"})
